...
public class ConversationProperties {
    ...
    /** Number of consecutive silent audio frames before treating as end-of-speech */
    private int silenceFrameThreshold = 25;
    ...
    /** Energy threshold below which a frame is considered silent (0-255 scale) */
    private int silenceEnergyThreshold = 8;
